...
// const navItmes = [
//   { to: "/dashboard", lable: "داشبورد" },
//   { to: "/invoices", lable: "فاکتور ها" },
//   { to: "/transactions", lable: "تراکنش ها" },
//   { to: "/reports", lable: "گزارش" },
//   { to: "/clients", lable: "مشتریان" },
// ];
...
//         <div className="sidebar-logo">دفتر درآمد</div>
//         <nav>
//           {navItmes.map((item) => (
//             <NavLink
//               key={item.to}
