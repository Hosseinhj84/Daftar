...
//   return monthNames[month] || isoMonth;
// }

// const PIE_COLORS = ["#0f766e", "#16a34a", "#ea580c", "#7c3aed", "#0891b2", "#dc2626", "#ca8a04"];
...
//     setLoading(true);
//     const response = await apiClient.get(`/dashboard/report/?months=${monthsRange}`);
...
//   const monthlyChartData = report.monthly.map((row) => ({
//     ...row,
...
//             {report.totals.total_income.toLocaleString("fa-IR")} تومان
//           </span>
//         </div>
//         <div className="summary-card">
//           <span className="card-label">کل هزینه</span>
//           <span className="card-value expense">
//             {report.totals.total_expense.toLocaleString("fa-IR")} تومان
//           </span>
//         </div>
//         <div className="summary-card">
//           <span className="card-label">سود خالص</span>
//           <span className="card-value">
//             {report.totals.net_profit.toLocaleString("fa-IR")} تومان
//           </span>
//         </div>
//       </div>

//       <div className="form-card">
//         <h3>مقایسه‌ی درآمد و هزینه در ماه‌های اخیر</h3>
...
//             <Legend />
//             <Bar dataKey="income" name="درآمد" fill="#16a34a" />
//             <Bar dataKey="expense" name="هزینه" fill="#dc2626" />
//           </BarChart>
//         </ResponsiveContainer>
//       </div>
...
//           <h3>سهم دسته‌بندی‌ها از کل هزینه‌ها</h3>
//           {report.category_breakdown.length === 0 ? (
//             <p className="empty-state">هزینه‌ای برای این بازه ثبت نشده است.</p>
//           ) : (
...
//                 <tr key={row.month}>
//                   <td>{row.label}</td>
//                   <td className="amount-positive">{row.income.toLocaleString("fa-IR")}</td>
//                   <td className="amount-negative">{row.expense.toLocaleString("fa-IR")}</td>
//                   <td>{row.net_profit.toLocaleString("fa-IR")}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
