...
//   // ورودی مثل "2026-08" — چون تاریخ‌ها میلادی ذخیره می‌شن، فقط برای نمایش ساده‌ی ماه استفاده می‌کنیم
...
//     setLoading(true);
//     const [summaryRes, trendRes, invoicesRes] = await Promise.all([
...
//     <Layout>
//       <h1>داشبورد</h1>
//       <p className="subtitle">خلاصه‌ای از وضعیت مالی شما</p>

//       <div className="summary-cards">
//         <div className="summary-card">
//           <span className="card-label">درآمد این ماه</span>
//           <span className="card-value income">
//             {Number(summary.total_income).toLocaleString("fa-IR")} تومان
//           </span>
//         </div>
//         <div className="summary-card">
//           <span className="card-label">هزینه این ماه</span>
//           <span className="card-value expense">
//             {Number(summary.total_expense).toLocaleString("fa-IR")} تومان
//           </span>
//         </div>
//         <div className="summary-card">
//           <span className="card-label">سود خالص</span>
//           <span className="card-value">
//             {Number(summary.net_profit).toLocaleString("fa-IR")} تومان
//           </span>
//         </div>
//         <div className="summary-card">
//           <span className="card-label">فاکتورهای معوق</span>
...
//         <h3>نمودار درآمد و هزینه در ۶ ماه اخیر</h3>
...
//             <Link to="/invoices">مشاهده همه</Link>
//           </div>
//         </div>
...
//                   <td>
//                     {Number(inv.total_amount).toLocaleString("fa-IR")} تومان
//                   </td>
//                   <td>
